...
const aggregations = exports.aggregations = {
    ...
    quartile1: (series, key) => d3A.quantile(colValues(series, key, true).sort(d3A.ascending), 0.25),
    median: (series, key) => d3A.median(colValues(series, key, true)),
    quartile3: (series, key) => d3A.quantile(colValues(series, key, true).sort(d3A.ascending), 0.75),
